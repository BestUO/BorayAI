...
class WCT(nn.Module):
    def __init__(self, config):
        ...
        self.e1 = encoder1(torch.load(config["vgg1"]))
        self.d1 = decoder1(torch.load(config["decoder1"]))
        self.e2 = encoder2(torch.load(config["vgg2"]))
        self.d2 = decoder2(torch.load(config["decoder2"]))
        self.e3 = encoder3(torch.load(config["vgg3"]))
        self.d3 = decoder3(torch.load(config["decoder3"]))
        self.e4 = encoder4(torch.load(config["vgg4"]))
        self.d4 = decoder4(torch.load(config["decoder4"]))
        self.e5 = encoder5(torch.load(config["vgg5"]))
        self.d5 = decoder5(torch.load(config["decoder5"]))
